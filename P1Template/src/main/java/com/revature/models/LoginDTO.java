...
//What the heck is a DTO?? Data Transfer Object. a DTO is mean to model some data coming in from the Front End
//An HTTP Handler will take in a JSON object sent in by the user, containing their username and password
//This HTTP Request data gets send to the controller, to get turned into a Java object using GSON
